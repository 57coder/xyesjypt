...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
           function goodsDel(id)
           {
               if(confirm('您确定删除吗？'))
               {
                   window.location.href="<%=path %>/goods?type=goodsDelHou&id="+id;
               }
           }
           
           function goodsAdd()
           {
                 var url="<%=path %>/admin/goods/goodsAddHou.jsp";
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/img/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="42" background="<%=path %>/img/tbg.gif">&nbsp;物品管理&nbsp;</td>
				</tr>
				...
				<tr align='center' bgcolor="#FFFFFF">
					...
					<td bgcolor="#FFFFFF" align="center"><a href="#" onclick="goodsDetailHou(${goods.id})" class="pn-loperator">物品描述</a></td>
					...
					<td bgcolor="#FFFFFF" align="center">
						...
						<a class="pn-loperator" href="<%=path %>/admin/goods/goodsEditHou.jsp?id=${goods.id}">修改</a>
					</td>
				</tr>
				</c:forEach>
			</table>

...
<html>
  ...
  <body class="body" leftmargin="0" rightmargin="0">
    <form action="order?type=orderPing" method="post">
     <table cellspacing="1" cellpadding="0" width="100%" border="0" bgcolor="#F7F3F7">
		  ...
		  <tr class="text" align="center" bgcolor="#FFFFFF">
			  ...
			  <td><img src="<%=path %>${orderItem.goods.fujian}" width="50px" height="50px"/>
			     
			  </td>
			  <td><textarea name="txt${orderItem.id}" cols="25" rows="5"></textarea>
			      <input type="hidden" name="goods${orderItem.id}" value="${orderItem.goods.id}"/>
			      <input type="hidden" name="goodsname${orderItem.id}" value="${orderItem.goods.mingcheng}"/>
			  </td>
		  </tr>
		  </c:forEach>
		   <tr height="26">
              <td class="blackTitle" align="center" colspan="3">

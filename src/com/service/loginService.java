...
public class loginService
{
	...
	public String login(String userName,String userPw,String vercode,int userType)
	{
		try
		{
			Thread.sleep(700);
    ...
    public List goodsAll()
    {
		...
		try
		{
			...
			while(rs.next())
			{
				...
				goods.setBianhao(rs.getInt("id")+":"+rs.getString("mingcheng"));
